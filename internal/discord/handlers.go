				...
				Embeds: []*discordgo.MessageEmbed{
					{
						...
						Description: "Я помогаю отслеживать прогресс гильдий на Sirus!\n\n" +
							...
							"Например  в гильдии есть несколько статик десятки смешанный с пугами, и сирус не засчитывает их килы как гильдейские" +
							"Вы можете отслеживать РЛа этого статика по его нику и бот будет присылать отчеты этого статика.",
						Color: 0xf1c40f,
					},
				},
			},
